...
struct handles_event
    : ::std::conditional<::std::is_same<typename Transition::event_type, Event>::value,
...
template <typename FSM, typename State, typename Event, typename Guard>
struct guard_check
    : ::std::conditional<guard_wants_event<Guard, FSM, State, Event>::value,
                         ...
                         typename ::std::conditional<
                             ...
                             guard_check<FSM, State, Guard, none>    // TODO Replace with concept
                                                                     // assert
                             >::type>::type {};
...
handle_in_state_event(Event&& event, FSM& fsm, State& state)
{
    ...
    return in_state_action_invocation<FSM, State, decayed_event>{}(::std::forward<Event>(event),
                                                                   fsm, state);
}
