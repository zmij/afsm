...
struct handled_events
    : std::conditional<traits::is_state_machine<T>::value, handled_events<state_machine<T>>,
...
struct handled_events<state<T>> {
    using type = typename handled_events<typename T::internal_transitions>::type;
};
...
template <typename Machine, typename State>
struct state_path : detail::state_path<Machine, State, traits::is_state_machine<Machine>::value> {};
...
template <typename T>
struct contains_pushdowns : detail::containts_pushdowns<T, traits::is_state_machine<T>::value> {};
...
template <typename T>
struct contains_popups : detail::containts_popups<T, traits::is_state_machine<T>::value> {};
...
template <typename T, typename Machine>
struct state_pushes : detail::state_pushes<T, Machine, traits::is_state_machine<T>::value> {};
...
template <typename T, typename Machine>
struct state_pops : detail::state_pops<T, Machine, traits::is_state_machine<T>::value> {};
