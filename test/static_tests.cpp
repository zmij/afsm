...
static_assert(
    std::is_same<detail::source_state<transition<stateA, eventAB, stateB>>::type, stateA>::value,
    "");
static_assert(
    std::is_same<detail::target_state<transition<stateA, eventAB, stateB>>::type, stateB>::value,
    "");
...
using transition_table_1
    = transition_table<transition<stateA, eventAB, stateB>, transition<stateA, eventAC, stateC>,
...
using events_in_state_a = psst::meta::find_if<def::originates_from<stateA>::template type,
                                              transition_table_1::transitions>;
using events_in_state_b = psst::meta::find_if<def::originates_from<stateB>::template type,
                                              transition_table_1::transitions>;
using events_in_state_c = psst::meta::find_if<def::originates_from<stateC>::template type,
                                              transition_table_1::transitions>;
...
struct my_state : state<my_state> {
    using internal_transitions
        = transition_table<internal_transition<eventAB>, internal_transition<eventBC>>;
};
...
static_assert(
    actions::detail::action_long_signature<action_long, eventAB, none, stateA, stateB>::value, "");
static_assert(
    !actions::detail::action_long_signature<action_short, eventAB, none, stateA, stateB>::value,
    "");
...
//----------------------------------------------------------------------------
static_assert(
    std::is_same<traits::exception_safety<stateA>::type, tags::basic_exception_safety>::value,
    "Default exception safety");
static_assert(
    std::is_same<traits::exception_safety<stateB>::type, tags::strong_exception_safety>::value,
    "Strong exception safety");
static_assert(std::is_same<traits::exception_safety<stateC>::type, tags::nothrow_guarantee>::value,
