...
struct state_name {
    ...
    on_enter(Event&&, FSM&)
    {
        ...
        std::cerr << (ansi_color::blue | ansi_color::bright) << std::setw(event_name_width)
                  << std::left << decayed_event::name << ansi_color::clear << ": Enter " << name()
                  << "\n";
    }
    ...
    {
        using psst::ansi_color;
        std::cerr << ansi_color::red << std::setw(event_name_width) << std::left << "[default]"
                  << ansi_color::clear << ": Enter " << name() << "\n";
    }
    template <typename Event, typename FSM>
    void
    on_exit(Event&&, FSM&)
    {
        ...
        std::cerr << (ansi_color::cyan | ansi_color::dim) << std::setw(event_name_width)
                  << std::left << decayed_event::name << ansi_color::clear << ": Exit " << name()
                  << "\n";
    }
    template <typename FSM>
    void
    on_exit(none const&, FSM&)
    {
        ...
        std::cerr << (ansi_color::red | ansi_color::dim) << std::setw(event_name_width) << std::left
                  << "[default]" << ansi_color::clear << ": Exit " << name() << "\n";
    }
};
