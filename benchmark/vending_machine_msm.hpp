...
struct vending_def : public ::boost::msm::front::state_machine_def<vending_def> {
    ...
    struct on_ : state_machine<on_> {
        ...
        struct maintenance_ : state_machine<maintenance_> {
            ...
            struct check_amount {
                ...
                bool
                operator()(events::load_goods const& goods, FSM const&, SourceState&,
                           TargetState&) const
                {
            ...
            struct check_price {
                template <typename FSM, typename SourceState, typename TargetState>
                bool
                operator()(events::set_price const& price, FSM const&, SourceState&,
                           TargetState&) const
                {
            ...
            struct set_price {
                template <typename FSM, typename SourceState, typename TargetState>
                void
                operator()(events::set_price const& price, FSM& fsm, SourceState&,
                           TargetState&) const
                {
        ...
        struct serving_ : state_machine<serving_> {
            ...
            struct enough_money {
                template <typename FSM, typename SourceState, typename TargetState>
                bool
                operator()(events::select_item const& item, FSM const& fsm, SourceState& state,
                           TargetState&) const
                {
            ...
            struct dispense {
                template <typename FSM, typename SourceState, typename TargetState>
                void
                operator()(events::select_item const& item, FSM& fsm, SourceState&,
                           TargetState&) const
                {
    ...
    vending_def(goods_storage const& goods) : secret{factory_code}, goods{goods}, balance{0} {}
